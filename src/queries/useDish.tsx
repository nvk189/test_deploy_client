...
export const useDishListStatusQuery = () => {
  return useQuery({
    queryKey: ["categoryes"],
    queryFn: dishApiRequest.liststatuCategory,
  });
};
export const useDishListByCategoryQuery = ({
  id,
  enabled,
}: {
  id: number;
  ...
  return useQuery({
    queryKey: ["dishes-by-category", id],
    queryFn: () => dishApiRequest.getDishCategory(id),
    enabled,
  });
};
